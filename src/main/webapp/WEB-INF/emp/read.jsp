...
<body>
	<form class="form-horizontal" 
		action="/ongo/idRead.do?state=UPDATE&id=${idRead.id}" 
		method="post" >
		...
		<div class="form-group">
			<div class="col-md-10 text-center">
				...
				<button type="button" class="btn btn-danger btn-lg"
					onclick="location.href='/ongo/listall.do'">
					<i class="fa fa-fw fa-close"></i> 목록
				</button>
				<button type="button" class="btn btn-danger btn-lg" id="deletebtn" onclick="location.href='/ongo/idDelete.do?id=${idRead.id}'">
