...
<body>
	...
	<div style="height:90px" style="padding:10px">
		<div id="toparea"  class="navbar navbar-inverse">
			<a href="/erp/index
		.do" style="position:absolute;top:30px;font-size: 18pt; font-weight: bolder;text-decoration: none;padding-left: 10px">KimSaemERP</a>
			 ...
			 style="position:relative ;top:20px" >
				...
				<c:choose>
						<c:when test="${user==null}" >
							...
							<a href="/ongo/reg_Page"><span class="glyphicon glyphicon-log-in">
								</span>    join</a></li>
							...
							<li style="margin-right: 20px;height: 70px">
							<a href="/ongo/login_Page"><span class="glyphicon glyphicon-log-in">
		 						</span>   Login</a></li>
							</ul>
						</c:when>
						...
						<c:otherwise>
							<li><a href="/ongo/logout.do"><span class="glyphicon glyphicon-log-out"></span>
									Logout</a></li>
							</ul>
							...
							<span  class="navbar-form pull-right" >	
								<img  class="img-circle" style="width: 60px;height: 70px"
											src="/ongo/images/<%-- ${user.profile_photo} --%> "  />
							</span>  
						</c:otherwise>
		...
		<div class="container-fluid">
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a href="#">커뮤니티</a></li>
					<li><a href="#">배달</a></li>
					<li><a href="/ongo/listall.do">ex)(관리자)회원리스트</a></li>
				</ul>
